...
export default function Thumbnails({
  ...
  return (
    <div
      className="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-6 lg:grid-cols-4 xl:grid-cols-6 gap-2 mt-2"
      role="tablist"
    ...
    >
      {images.map((image, index) => (
        ...
        >
          ...
          {/* Hover overlay */}
          <div
            className="absolute inset-0 bg-black/0 group-hover:bg-black/20 rounded transition-colors duration-200"
            aria-hidden="true"
          />
        </button>
      ))}
